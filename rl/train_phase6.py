...
# Rack apex (head ball) at the foot spot of the table.
RACK_APEX = (75.0, 25.0)

# Standard 14.1 rack: 5 rows, 1+2+3+4+5 = 15 balls. Balls are tight (touching).
# Spacing: row-to-row = 2R * cos(30°) = 2R * √3/2; within-row = 2R.
